...
export default function Home() {
  return (
    <div className="min-h-screen bg-linear-to-br from-neutralBeige to-elegantWhite flex flex-col items-center justify-center">
      <main className="flex flex-col items-center text-center px-4 min-h-screen justify-center relative w-full">
        ...
        <h1
          className="text-6xl font-bold text-warmOrange mb-4 bg-linear-to-r bg-clip-text text-transparent from-orange-400 to-orange-700 tracking-wide hero-text-1"
      ...
      <section className="w-full max-w-3xl mt-10 text-center min-h-screen flex justify-center flex-col items-center gap-5 px-5 md:px-0">
        <h2 className="text-3xl md:text-4xl bg-linear-to-r bg-clip-text text-transparent from-orange-400 to-orange-700 font-bold text-appetizingRed mb-6">
          Website Features
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-blue-100 hover:bg-blue-200 transition duration-300 ease-in-out transform hover:scale-105 shadow-md rounded-lg p-6 hover:shadow-lg flex flex-col items-center">
            ...
            <h3 className="text-xl font-semibold text-warmOrange bg-linear-to-r bg-clip-text text-transparent from-orange-600 to-yellow-700">
              Genuine Recipes
            </h3>
